    ...
    <div className={styles.footer}>
        <div className={styles.upperfooter}>
            ...
            <div className={styles.icons}>
                <a href="https://github.com/Aji-ncodew" target="_blank" rel="noreferrer">
                ...
                <a href="mailto:ajincodew@gmail.com" target="_blank" rel="noreferrer">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.linkedin.com/company/ajincodew/" target="_blank" rel="noreferrer">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.youtube.com/@aji_ncodew" target="_blank" rel="noreferrer">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={styles.lowerfooter}>
            <p>
                © 2023 Aji ncodew, <a className={styles.pccoelink} href="" target="_blank" rel="noreferrer">Moroccan organization</a> All Right Reserved.
            </p>
        </div>
    </div>
  )
